...
function pickTwelveLeadPattern(ecgType, rhythmInterp, twelveLeadFindings, fifteenLeadFindings) {
  ...
  if (txt.includes('hyperkal') || txt.includes('tented t') || (txt.includes('peaked t') && (txt.includes('potassium') || txt.includes('dialysis') || txt.includes('renal') || txt.includes('flattened p') || txt.includes('widened qrs'))) || (txt.includes('widened qrs') && txt.includes('flattened p') && txt.includes('peaked'))) return 'hyperkalemia';
